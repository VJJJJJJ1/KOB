...
//         this.step = 0;       //回合数
//         this.eps = 1e-2;    //允许的误差，当两个点距离小于eps时，可认为两个点重合

//         this.eye_direction = 0;
//         //规定左下角蛇初始向上，右上角的蛇初始向下
//         if(this.id === 1) this.eye_direction = 2;
//         this.eye_dx = [    //蛇眼睛不同方向的x的偏移量(两只眼)
//             [-1, -1],
//             [-1, 1],
//             [1, 1],
//             [1, -1]
...
//         if(!this.check_tail_increasing()){  //蛇不变长的话就减一个球
//             this.cells.pop();
//         }
//         else{
//             //每两帧之间走的距离
